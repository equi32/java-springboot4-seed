...
class SpringBoot4ContainersIntegrationTest {
     ...
     * <p>
     * Spring Boot 4 creates this bean automatically via
     * {@link TestContainersConfiguration#mockServerClient(MockServerContainer)}.
    ...
    void shouldConfigureMockServerExpectations() {
        ...
        mockServerClient
                .when(request().withPath("/api/external/products/1").withMethod("GET"))
