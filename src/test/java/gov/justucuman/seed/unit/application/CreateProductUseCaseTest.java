...
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.productForCreation;
...
class CreateProductUseCaseTest {
    ...
    class NullHandlingTests {
        ...
        void shouldHandleProductWithNullName() {
            // Given
            Product productWithNullName = product().name(null).buildForCreation();
    ...
    class ExceptionHandlingTests {
        ...
        void shouldPropagateExceptionWhenEventPublisherFails() {
            ...
            org.mockito.Mockito.doThrow(exception).when(eventPublisherPort).perform(savedProduct);
        ...
        void shouldHandleIllegalStateExceptionFromSavePort() {
            ...
            given(productSavePort.perform(inputProduct)).willThrow(new IllegalStateException("Invalid product state"));
