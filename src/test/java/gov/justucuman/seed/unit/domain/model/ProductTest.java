...
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.anotherId;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultCreatedAt;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultDescription;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultId;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultName;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultPrice;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultProduct;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultStatus;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultStock;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.defaultUpdatedAt;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.discontinuedProduct;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.newId;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.nullProduct;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.outOfStockProduct;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.preOrderProduct;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.product;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.productWithBlankStrings;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.productWithLargePrice;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.productWithMaxStock;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.productWithNegativePrice;
import static gov.justucuman.seed.unit.domain.model.ProductTestFactory.productWithNegativeStock;
...
class ProductTest {
    ...
    class EdgeCasesTests {
        ...
        void shouldHandleAllProductStatusValues() {
            ...
            Product available = product().status(ProductStatus.AVAILABLE).build();
        ...
        void shouldHandleLocalDateTimeWithNanoseconds() {
            ...
            // When
            Product product = product().createdAt(timeWithNanos).build();
