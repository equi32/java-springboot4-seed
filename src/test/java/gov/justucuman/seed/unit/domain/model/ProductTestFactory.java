...
public final class ProductTestFactory {
    ...
    public static Product productForCreation() {
        return new Product(
                null, DEFAULT_NAME, DEFAULT_DESCRIPTION, DEFAULT_PRICE, DEFAULT_STOCK, DEFAULT_STATUS, null, null);
    }
    ...
    public static final class ProductBuilder {
        ...
        public Product build() {
            return new Product(id, name, description, price, stock, status, createdAt, updatedAt);
        }
        ...
        public Product buildForCreation() {
            return new Product(null, name, description, price, stock, status, null, null);
        }
    }
